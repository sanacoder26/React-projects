...
function LostFound() {
  ...
  // ✅ Step 1: fetchItems ko useCallback mein wrap karein (useEffect se pehle)
  ...
  // ✅ Step 2: useEffect - fetchItems ko dependency mein add karein
  useEffect(() => {
    if (!user) return;
  ...
  }, [user, fetchItems]); // ✅ fetchItems dependency add ki
