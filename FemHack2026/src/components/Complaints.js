...
function Complaints() {
  ...
  // ✅ Step 1: fetchComplaints ko useCallback mein wrap karein
  ...
  // ✅ Step 2: useEffect with fetchComplaints dependency
  useEffect(() => {
    if (!user) return;
  ...
  }, [user, fetchComplaints]); // ✅ fetchComplaints dependency add kiya
